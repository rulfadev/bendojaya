@php
    ...
    $title = $setting?->maintenance_title ?: 'Bendo Jaya Batik Fashion Sedang Diperbarui';
    $description =
        $setting?->maintenance_description ?:
        'Website Bendo Jaya Batik Fashion sedang kami siapkan kembali dengan tampilan dan sistem baru.';
        ...
        <section class="relative mx-auto flex min-h-screen max-w-7xl items-center px-5 py-12 lg:px-8">
            <div class="max-w-3xl">
                ...
                <div class="mt-14 grid max-w-2xl gap-6 border-t border-[#FBE9CB]/20 pt-8 sm:grid-cols-3">
                    <div>
                        <p class="font-['Playfair_Display'] text-3xl font-black">Batik</p>
                        <p class="mt-1 text-xs font-bold uppercase tracking-[0.2em] text-[#EEBDB5]">Fashion</p>
                    </div>

                    <div>
                        <p class="font-['Playfair_Display'] text-3xl font-black">Custom</p>
                        <p class="mt-1 text-xs font-bold uppercase tracking-[0.2em] text-[#EEBDB5]">Produksi</p>
                    </div>

                    <div>
                        <p class="font-['Playfair_Display'] text-3xl font-black">Brand</p>
